...
import { getTimeline, deleteMemory, type TimelineEvent } from '../src/api/memory.js';
...
describe('<GrowthPage />', () => {
  ...
  it('按 created_at 倒序渲染事件并展示中文类型标签', async () => {
    ...
    mockedGetTimeline.mockResolvedValueOnce(events);
